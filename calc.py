...
if __name__ == "__main__":
	...
	gui.geometry("325x225")

	equation = StringVar()

	expression_field = Entry(gui, textvariable=equation)

	expression_field.grid(columnspan=200, ipadx=200)
	...
	undo = Button(gui, text='Undo', fg='black', bg='red',
				command=undo, height=2, width=10)        
	undo.grid(row=6, column='2')
